...
pocRoutes.post('/getSchema', runAsyncWrapper(v2Routes.showSchema));
pocRoutes.post('/getDAG', runAsyncWrapper(v2Routes.showDAG));
...
pocRoutes.post('/pool/getSchema', runAsyncWrapper(v3Routes.showSchemaPool));
pocRoutes.post('/pool/getDAG', runAsyncWrapper(v3Routes.showDAGPool));
